...
const { getLessons, getLessonById, createLesson, updateLesson, deleteLesson, toggleLessonStatus, addCriteria, updateCriteria, deleteCriteria } = require('../controllers/lessonController');
