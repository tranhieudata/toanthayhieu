...
import { FiPlus, FiEdit2, FiTrash2, FiX, FiUsers, FiArrowLeft, FiToggleLeft, FiToggleRight, FiBook, FiChevronDown, FiChevronRight } from 'react-icons/fi';
              ...
              <div className="card overflow-hidden">
                {classEnrollments.length === 0 ? (
                  <div className="p-8 text-center text-gray-500">
                    ...
                    <p>Chưa có học sinh nào được duyệt vào lớp</p>
                  </div>
                ) : (
        ...
        {modal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={async (e) => { await handleSubmit(e); setSelectedClass(prev => ({ ...prev, ...form })); }} className="p-6 space-y-4">
                <div>
